...
urlpatterns = [
    ...
    path('dashboard/history/<int:patient_id>/', template_views.consultation_history, name='patient_consultation_history'),
    ...
    path('medicine/<int:medicine_id>/edit/', template_views.edit_medicine, name='edit_medicine'),
    path('medicine/<int:medicine_id>/delete/', template_views.delete_medicine, name='delete_medicine'),
